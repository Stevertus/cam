...
execute as @e[tag=cam.point] at @s run particle minecraft:bubble_pop ~ ~ ~ 0 0 0 0.0 1 normal @a[tag=!cam.moving,tag=!cam.hideParticles]
execute as @e[tag=cam.camera] at @s run function cam:objd/execute1
